            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row margin-bottom-30">
                        <div class="col-md-4">
                            <h5>Extra Oral</h5>
                            <button type="button" class="btn btn-violet margin-bottom-10">Frontal</button>
                            <button type="button" class="btn btn-primary margin-bottom-10">Frontal Smiling</button>
                            <button type="button" class="btn btn-success margin-bottom-10">Lateral</button>
                        </div>
                        <div class="col-md-5">
                            <h5>Intra Oral</h5>
                            <button type="button" class="btn btn-violet margin-bottom-10">Frontal</button>
                            <button type="button" class="btn btn-primary margin-bottom-10">Right</button>
                            <button type="button" class="btn btn-success margin-bottom-10">Left</button>
                            <button type="button" class="btn btn-warning margin-bottom-10">Upper</button>
                            <button type="button" class="btn btn-violet margin-bottom-10">Lower</button>
                        </div>
                        <div class="col-md-3">
                            <h5>X-Ray</h5>
                            <button type="button" class="btn btn-violet margin-bottom-10">Lateral</button>
                            <button type="button" class="btn btn-primary margin-bottom-10">OPG</button>
                        </div>
                    </div>
                </div>
            </div>
            {/* <!-- <div class="row">
                <div class="col-md-12">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                <td><button type="button" class="btn btn-violet margin-bottom-10 waves-effect waves-light">file 1</button></td>
                                <td><button type="button" class="btn btn-primary margin-bottom-10 waves-effect waves-light">file 2</button></td>
                                <td><button type="button" class="btn btn-success margin-bottom-10 waves-effect waves-light">file 3</button></td>
                                <td><button type="button" class="btn btn-warning margin-bottom-10 waves-effect waves-light">file 4</button></td>
                                <td><button type="button" class="btn btn-violet margin-bottom-10 waves-effect waves-light">file 5</button></td>
                                <td><button type="button" class="btn btn-primary margin-bottom-10 waves-effect waves-light">file 6</button></td>
                                <td><button type="button" class="btn btn-success margin-bottom-10 waves-effect waves-light">file 7</button></td>
                                <td><button type="button" class="btn btn-warning margin-bottom-10 waves-effect waves-light">file 8</button></td>
                                <td><button type="button" class="btn btn-warning margin-bottom-10 waves-effect waves-light">file 9</button></td>
                                <td><button type="button" class="btn btn-warning margin-bottom-10 waves-effect waves-light">file 10</button></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="box-content">
                        ...
                        <input style={{marginLeft: 60 + "px"}} type="checkbox" name="Select" id=""/>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h5>Comments:</h5>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Explicabo, officia nisi sequi repellat animi at blanditiis!</p>
                            </div>
                            <div class="col-md-6">
                                <h5>Sets:</h5>
                                <table class="table">
                        ...
                        {/* <!-- <input style="margin-left: 60px;" type="checkbox" name="Select" id=""> --> */}
                ...
                <div class="col-md-6">
                    <div class="box-content">
                        ...
                        {/* <!-- /.dropdown js__dropdown --> */}
                        <button type="button" class="btn btn-violet margin-bottom-10 waves-effect waves-light" data-toggle="modal" data-target="#boostrapModal-1">Request Change</button>
                        <button type="button" class="btn btn-success margin-bottom-10 waves-effect waves-light" data-toggle="modal" data-target="#continue">Continue</button>
                        <button type="button" class="btn btn-danger margin-bottom-10 waves-effect waves-light" data-toggle="modal" data-target="#boostrapModal-3">Not</button>
                        <a href="tacupload.html" class="btn btn-warning margin-bottom-10 waves-effect waves-light">Upload</a>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-display">
                        <form class="margin-top-30">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Transaction Image</label>
