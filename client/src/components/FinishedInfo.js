        ...
        <div class="content">
            ...
            <div class="navigation">
                ...
                <ul class="menu js__accordion">
                    ...
                    <li>
                        <a href="processing_forms.html"><i class="menu-icon fa fa-adjust"></i><span>Processing Forms</span></a>
    ...
    <div id="wrapper">
        <div class="main-content">
            <div class="row small-spacing">
                <div class="col-md-12">
                    <button class="btn btn-primary margin-bottom-20 btn-lg">Refinement</button>
                </div>
                ...
                <div class="col-md-6">
                    <div class="box-content">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h5>Comments:</h5>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda corporis enim nemo sequi reprehenderit natus!</p>
                            </div>
                            <div class="col-md-6">
                                <h5>Sets:</h5>
                                <table class="table">
                    ...
                    <div class="box-content">
                        ...
                        <table class="table margin-bottom-0">
                            <tbody>
                                ...
                                <tr class="payment-msg">
                                    <td>Your Process Status is:</td>
                                    <td>Finished</td>
                                </tr>
                            </tbody>
                        </table>
